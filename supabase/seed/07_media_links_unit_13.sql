...
from (values
  ...
  ('/project-media/' || 'palmhills/hacienda-blue/units/location-hacienda-blue.webp','location',0,array['HB-01','HB-02','HB-03','HB-04','HB-05']),
  ('/project-media/' || 'palmhills/ph-new-cairo/units/loation-ph.webp','location',0,array['PHN-01','PHN-02','PHN-03','PHN-04','PHN-05','PHN-06']),
  ('/project-media/' || 'palmhills/px/units/location-px.webp','location',0,array['PX-01','PX-02','PX-03','PX-04','PX-05','PX-06','PX-07']),
  ...
  ('/project-media/' || 'palmhills/hacienda-blue/units/mp-hacienda-blue.webp','masterplan',0,array['HB-01','HB-02','HB-03','HB-04','HB-05']),
  ('/project-media/' || 'palmhills/ph-new-cairo/units/mp-pl.webp','masterplan',0,array['PHN-01','PHN-03','PHN-04','PHN-05','PHN-06']),
  ('/project-media/' || 'palmhills/px/units/mp-px.webp','masterplan',0,array['PX-01','PX-02','PX-03','PX-04','PX-05','PX-06','PX-07']),
