...
{slug:'marsa-baghush', name:'Marsa Baghush', name_ar:'مرسى باغوش', dev:'baghush', area:'sahel', status:'launch', types:{en:'Chalet · Villa',ar:'شاليه · فيلا'}, tags:{en:['Sidi Heneish','Five swimmable lagoons','Six clusters'],ar:['سيدي حنيش','خمس بحيرات للسباحة','ستة أحياء']}, blurb:{en:'A gem of the North Coast at Sidi Heneish, just off the coastal road and linked to Cairo via the El Alamein and Dabaa roads. Five crystal-clear lagoons — each over 50 metres wide and 300 metres long, swimmable and lifeguarded — run through six named clusters: The Vineyard, Lemon Bliss, Olive Grove, the Fig Cluster, the Plum Line and Melon Villas. A botanical spine and bike paths link the homes to 20+ commercial shops and restaurants, a state-of-the-art fitness facility and beach service. Chalets and villas from 115 to 615 m². Developer-direct primary units.',ar:'جوهرة الساحل الشمالي في سيدي حنيش، على مقربة من الطريق الساحلي ومتصلة بالقاهرة عبر طريقي العلمين والضبعة. خمس بحيرات صافية — كل واحدة أكثر من ٥٠ متراً عرضاً و٣٠٠ متر طولاً، قابلة للسباحة وبمنقذين — تمتد بين ستة أحياء: ذا فينيارد، ليمون بليس، أوليف جروف، فيج كلاستر، ذا بلَم لاين، وميلون فيلاز. يربط عمود أخضر ومسارات دراجات المنازل بأكثر من ٢٠ متجراً ومطعماً، ومركز لياقة حديث، وخدمة على الشاطئ. شاليهات وفيلات من ١١٥ إلى ٦١٥ م². وحدات أولية من المطوّر مباشرة.'}},
...
{slug:'aeon', name:'Aeon', name_ar:'إيون', dev:'marakez', area:'october', status:'launch', price:3100000, dp:10, years:8, delivery:'2026', finishing:{en:'Semi-finished',ar:'نصف تشطيب'}, types:{en:'Apartment · Studio · Clinic · Administrative Office',ar:'شقة · استوديو · عيادة · مكتب إداري'}, tags:{en:['6th of October','Mixed-use'],ar:['٦ أكتوبر','متعدد الاستخدامات']}, blurb:{en:'A mixed-use launch in 6th of October pairing homes with retail and offices.',ar:'إطلاق متعدد الاستخدامات ب٦ أكتوبر يجمع السكن مع التجزئة والمكاتب.'}},
...
{id:'AE-S01',  project:'aeon',                type:'Studio',           beds:0, baths:1, area:52,  price:3100000,  avail:'available'},
{id:'AE-CL2',  project:'aeon',                type:'Clinic',           beds:0, baths:1, area:70,  price:6400000,  avail:'available'},
...
{id:'AE-AO3',  project:'aeon',                type:'Administrative Office', beds:0, baths:1, area:110, price:9200000, avail:'available', floor:'middle'},
...
'ZE-P08':{floor:'top',roof:true},'HP-P03':{floor:'top',roof:true},'IB-S02':{floor:'low'},'AE-S01':{floor:'middle'},
...
var UNIT_IMAGES = {
'AE-S01':'/project-media/ramla/units/ap-a-05.webp',
'AE-CL2':'/project-media/ramla/units/ap-a-01.webp',
'AE-AO3':'/project-media/ramla/units/ap-a-02.webp',
