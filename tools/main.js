...
{slug:'ramla-ras-el-hekma', name:'Ramla', name_ar:'رملة', dev:'marakez', area:'raselhekma', status:'launch', price:23418000, dp:10, years:7, delivery:'2027', finishing:{en:'Fully finished',ar:'تشطيب كامل'}, types:{en:'Chalet · Duplex · Penthouse · Townhouse · Twin house · Villa',ar:'شاليه · دوبلكس · بنتهاوس · تاون هاوس · توين هاوس · فيلا'}, tags:{en:['Ras El Hekma','1.4km beach','5% down'],ar:['رأس الحكمة','شاطئ ١٫٤ كم','مقدم ٥٪']}, blurb:{en:'Marakez’s Ramla at Kilo 215, Ras El Hekma — a 402-acre beachfront community (WATG master plan) with a 1.4km beach, a 22-acre lagoon and a 13-acre sports campus. Fully finished chalets, townhomes, twin houses and standalone villas with concealed AC, plus collaborations with Adrère Amellal, Azza Fahmy and Mariolino. Delivery within ~3.5 years; from 5% down over up to 8 years. Developer-direct primary units.',ar:'وجهة رملة من مراكز عند الكيلو ٢١٥ برأس الحكمة — مجتمع شاطئي على ٤٠٢ فدان (تخطيط WATG) بشاطئ ١٫٤ كم وبحيرة ٢٢ فداناً وكامباس رياضي ١٣ فداناً. شاليهات وتاون هاوس وتوين هاوس وفيلات مستقلة كاملة التشطيب بتكييف مخفي، بالتعاون مع Adrère Amellal وعزة فهمي وMariolino. التسليم خلال ٣٫٥ سنوات تقريباً؛ من مقدم ٥٪ وتقسيط حتى ٨ سنوات. وحدات أولية من المطوّر مباشرة.'}},
