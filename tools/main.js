...
{key:'marakez', c1:'#b0473f', name:{en:'Marakez',ar:'مراكز'}, since:2014, areas:{en:'New Cairo · 6th of October · Ras El Hekma',ar:'القاهرة الجديدة · ٦ أكتوبر · رأس الحكمة'}, tagline:{en:'Mixed-use, retail-led districts',ar:'أحياء متعددة الاستخدامات'}, desc:{en:'A retail-led developer creating walkable mixed-use districts that combine residences, offices and destination retail.',ar:'مطوّر رائد في التجزئة ينشئ أحياءً متعددة الاستخدامات تجمع السكن والمكاتب والتجزئة.'}},
...
{slug:'district-5', name:'District 5', name_ar:'ديستريكت ٥', dev:'marakez', area:'newcairo', status:'primary', price:7000000, dp:10, years:8, delivery:'2027', finishing:{en:'Semi-finished',ar:'نصف تشطيب'}, types:{en:'Apartment',ar:'شقق'}, tags:{en:['Mixed-use','Retail-led'],ar:['متعدد الاستخدامات','تجزئة']}, blurb:{en:'A walkable mixed-use district in New Cairo combining residences and destination retail.',ar:'حي متعدد الاستخدامات بالقاهرة الجديدة يجمع السكن والتجزئة.'}},
...
{id:'D5-A22',  project:'district-5',          type:'Apartment',        beds:2, baths:2, area:140, price:7000000,  avail:'available'},
{id:'D5-O11',  project:'district-5',          type:'Office',           beds:0, baths:1, area:90,  price:8100000,  avail:'to-confirm'},
...
{id:'D5-A0T',  project:'district-5',          type:'Apartment',        beds:null, baths:2, area:130, price:6600000, avail:'to-confirm'},
...
'BF-A09':{floor:'ground',garden:true},'FS-A18':{floor:'high'},'D5-A22':{floor:'middle'},'TS-A07':{floor:'top'},
...
var areaStr=(u.area!=null?num(u.area)+' m²':'—');
...
function spec(icon, val, label){ return h('span',{class:'spec'}, ic(icon), h('b',null, (val==null?'—':num(val))), h('span',{class:'spec-lbl'}, label)); }
...
var card=h('article',{class:'card'});
var uc=unitCanon(u), tl=typeLabelC(uc);
...
h('div',{class:'spec-row'}, unitIsCommercial(u)?null:spec('bed',u.beds, lang==='ar'?'غرف':'beds'), unitIsCommercial(u)?null:spec('bath',u.baths, lang==='ar'?'حمام':'baths'), spec('area',u.area,'m²')),
...
add('unit',typeLabelC(unitCanon(u))+' — '+(lang==='ar'?p.name_ar:p.name),L(a.name)+' · '+money(u.price),buildPath('project',{slug:p.slug}),
...
.forEach(function(r){ if(r[2]) return; facts.appendChild(h('tr',null,h('th',{scope:'row'},r[0]),h('td',null,r[1]))); });
...
'name': L({en:p.name,ar:p.name_ar})+' · '+typeLabelC(unitCanon(u)),
...
var p=projBySlug(u.project), dev=devByKey(p.dev), area=areaByKey(p.area);
var pnm=lang==='ar'?p.name_ar:p.name, tl=typeLabelC(unitCanon(u));
...
unitIsCommercial(u)?null:spec('bed',u.beds, lang==='ar'?'غرف':'beds'), unitIsCommercial(u)?null:spec('bath',u.baths, lang==='ar'?'حمام':'baths'), spec('area',u.area,'m²')),
h('div',{class:'card__foot',style:'margin-top:16px;flex-wrap:wrap'},
...
[(lang==='ar'?'المساحة':'Area'), u.area!=null?num(u.area)+' m²':'—'],
[t('delivery'), p.delivery==='Ready'?t('ready'):(p.delivery||t('to_confirm'))]]
...
h('span',{class:'chip chip--muted'}, (lang==='ar'?'منذ ':'Since ')+d.since))),
...
{k:t('type'), f:function(u){return typeLabelC(unitCanon(u));}},
...
{k:(lang==='ar'?'المساحة':'Area'), f:function(u){return u.area!=null?(num(u.area)+' m²'):'—';}},
