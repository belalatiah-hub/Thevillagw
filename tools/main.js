...
{slug:'zed-east', name:'ZED East', name_ar:'زيد إيست', dev:'ora', area:'newcairo', status:'primary', price:9800000, dp:10, years:8, delivery:'2028', finishing:{en:'Fully finished',ar:'تشطيب كامل'}, types:{en:'Apartment · Loft · Penthouse',ar:'شقة · لوفت · بنتهاوس'}, tags:{en:['Premium','Lifestyle'],ar:['بريميوم','لايف ستايل']}, blurb:{en:'A design-led lifestyle destination in East Cairo, developer-direct primary units.',ar:'وجهة لايف ستايل بتصميم مميّز بشرق القاهرة، وحدات أولية من المطوّر مباشرة.'}},
...
{slug:'beit-al-bahr', name:'Beit Al Bahr', name_ar:'بيت البحر', dev:'beitalbahr', area:'sahel', status:'launch', finishing:{en:'Fully finished',ar:'تشطيب كامل'}, types:{en:'Chalet · Townhouse · Villa · Duplex · Loft · Serviced Apartment',ar:'شاليه · تاون هاوس · فيلا · دوبلكس · لوفت · شقة فندقية'}, tags:{en:['Sidi Heneish','450 acres','3.5 km beachfront'],ar:['سيدي حنيش','٤٥٠ فدان','٣٫٥ كم شاطئ']}, blurb:{en:'A refined beachfront escape spread over 450 acres at El-Abd Resort, Sidi Heneish, with a private 3.5 km beach on the Mediterranean. The master plan loops around people and privacy, bringing homes closer to the seafront, the shimmering pools and the swimmable lagoons, with four boutique hotels, F&B tenants along the shore and native plantations throughout. Design draws on the four elements of life — air, water, earth and fire. Developer-direct primary units.',ar:'ملاذ شاطئي راقٍ على ٤٥٠ فداناً في منتجع العبد بسيدي حنيش، بشاطئ خاص ٣٫٥ كم على البحر المتوسط. الماستر بلان يلتف حول الناس والخصوصية، فيقرّب المنازل من الشاطئ وحمامات السباحة والبحيرات القابلة للسباحة، مع أربعة فنادق بوتيك ومطاعم على الشاطئ ونباتات محلية في كل مكان. التصميم مستوحى من عناصر الحياة الأربعة — الهواء والماء والأرض والنار. وحدات أولية من المطوّر مباشرة.'}},
...
{id:'ZE-L02',  project:'zed-east',            type:'Loft',             beds:1, baths:1, area:88,  price:6900000,  avail:'available'},
{id:'ZE-P08',  project:'zed-east',            type:'Penthouse',        beds:3, baths:3, area:245, price:16800000, avail:'limited'},
...
{id:'ZE-SV1',  project:'zed-east',            type:'Sky Villa',        beds:4, baths:4, area:300, price:24500000, avail:'limited',   floor:'top', roof:true},
...
{id:'ZD-AP1', project:'zed-zayed',          type:'Apartment',        beds:2, baths:2, area:140, price:13500000, avail:'available'},
{id:'ZD-PH1', project:'zed-zayed',          type:'Penthouse',        beds:3, baths:3, area:210, price:22000000, avail:'limited'},
{id:'SS-CH1', project:'silversands-sahel',  type:'Chalet',           beds:3, baths:3, area:130, price:15000000, avail:'available'},
{id:'SS-VL1', project:'silversands-sahel',  type:'Villa',            beds:4, baths:4, area:240, price:32000000, avail:'limited'},
...
'beit-al-bahr':'/project-media/beitalbahr/lagoon.webp',
'marsa-baghush':'/project-media/baghush/beach-aerial.webp',
...
'MB-V02':'/project-media/baghush/units/v1-03.webp',
...
'V-A305':'/project-media/villette/apartment.webp', 'V-TH22':'/project-media/villette/town-house.webp', 'VL-IV3':'/project-media/villette/i-villa.webp',
'SE-T12':'/project-media/sodic-east/town-house.webp', 'SE-A44':'/project-media/sodic-east/apartment.webp',
'ET-D07':'/project-media/eastown/duplex.webp', 'ET-A12':'/project-media/eastown/apartment.webp',
'AL-V03':'/project-media/allegria/standalone.webp', 'AL-TW6':'/project-media/allegria/twin-house.webp', 'AL-TV2':'/project-media/allegria/town-house.webp',
'OG-WC1':'/project-media/ogami/chalet.webp', 'OG-TH1':'/project-media/ogami/town-house.webp', 'OG-TW1':'/project-media/ogami/twin-house.webp',
'CS-TH1':'/project-media/caesar/town-house.webp', 'CS-TW1':'/project-media/caesar/twin-house.webp', 'CS-SV1':'/project-media/caesar/standalone.webp',
'JN-CR1':'/project-media/june/standalone-june.webp', 'JN-OP1':'/project-media/june/standalone-254.webp',
'ES-AP1':'/project-media/the-estates/apartment.webp', 'ES-VL1':'/project-media/the-estates/villa.webp',
'SEM-CL1':'/project-media/lmd/sem-cl1-r1.webp', 'SEM-CL2':'/project-media/lmd/sem-cl2-r1.webp',
'TS-AD1':'/project-media/lmd/ts-ad1-r1.webp', 'TS-AD2':'/project-media/lmd/ts-ad2-r1.webp', 'TS-CL3':'/project-media/lmd/ts-cl3-r1.webp',
'TS-AD4':'/project-media/lmd/ts-ad4-r1.webp', 'TS-OF5':'/project-media/lmd/ts-of5-r1.webp',
'STH-OF1':'/project-media/lmd/sth-of1-r1.webp', 'SES-AD1':'/project-media/lmd/ses-ad1-r1.webp', 'ON-RT1':'/project-media/lmd/on-rt1-r1.webp',
'ZY-SV1':'/project-media/lmd/zy-sv1-r1.webp', 'ZY-HV2':'/project-media/lmd/zy-hv2-r1.webp', 'ZY-TW3':'/project-media/lmd/zy-tw3-r1.webp',
'ZY-CH4':'/project-media/lmd/zy-ch4-r1.webp', 'ZY-CB5':'/project-media/lmd/zy-cb5-r1.webp',
...
'MB-V03':["/project-media/baghush/units/v2-0.webp", "/project-media/baghush/units/v2-01.webp"],
'MB-V04':["/project-media/baghush/units/v3-0.webp", "/project-media/baghush/units/v3-01.webp"],
'MB-CH01':["/project-media/baghush/units/ch1-0.webp", "/project-media/baghush/units/ch1-01.webp"],
'MB-CH02':["/project-media/baghush/units/ch2-0.webp", "/project-media/baghush/units/ch2-01.webp"],
'MB-CH03':["/project-media/baghush/units/ch2-01.webp", "/project-media/baghush/units/ch2-0.webp"],
'MB-TW01':["/project-media/baghush/units/t-0.webp", "/project-media/baghush/units/t-01.webp"],
'MB-CH05':["/project-media/baghush/units/ch5-0.webp", "/project-media/baghush/units/ch5-01.webp"],
'MB-CH06':["/project-media/baghush/units/ch7-0.webp", "/project-media/baghush/units/ch7-01.webp"],
'MB-CH07':["/project-media/baghush/units/v1-02.webp", "/project-media/baghush/units/v1-0.webp", "/project-media/baghush/units/v1-03.webp"],
'RM-VL01':["/project-media/ramla/units/v1-0.webp", "/project-media/ramla/units/v1-01.webp", "/project-media/ramla/units/v1-02.webp"],
'RM-TW01':["/project-media/ramla/units/tw2-0.webp", "/project-media/ramla/units/tw-r-0.webp", "/project-media/ramla/units/tw1-r-0.webp", "/project-media/ramla/units/tw2-01.webp", "/project-media/ramla/units/tw2-02.webp", "/project-media/ramla/units/tw2-03.webp"],
'RM-DX01':["/project-media/ramla/units/du-02.webp", "/project-media/ramla/units/du-0.webp", "/project-media/ramla/units/du-01.webp", "/project-media/ramla/units/du-03.webp", "/project-media/ramla/units/du-04.webp"],
'RM-PH01':["/project-media/ramla/units/du-0.webp", "/project-media/ramla/units/du-01.webp", "/project-media/ramla/units/du-02.webp", "/project-media/ramla/units/du-03.webp", "/project-media/ramla/units/du-04.webp"],
...
'RM-DX03':["/project-media/ramla/units/du2-0.webp", "/project-media/ramla/units/du2-01.webp", "/project-media/ramla/units/du2-02.webp"],
...
'RM-DX04':["/project-media/ramla/units/DU3-0.webp", "/project-media/ramla/units/DU3-01.webp", "/project-media/ramla/units/DU3-02.webp", "/project-media/ramla/units/DU3-03.webp"],
...
'RM-CH06':["/project-media/ramla/units/ch6-0.webp", "/project-media/ramla/units/ch6-01.webp"],
...
'D5-A03':["/project-media/marakez/units/ap3-d-0.webp", "/project-media/marakez/units/ap3-d-01.webp", "/project-media/marakez/units/ap3-d-02.webp", "/project-media/marakez/units/ap3-d-03.webp", "/project-media/marakez/units/ap3-d-04.webp"],
...
'D5-A07':["/project-media/marakez/units/ap7-d-0.webp", "/project-media/marakez/units/ap7-d-01.webp", "/project-media/marakez/units/ap7-d-02.webp"],
...
'D5-A13':["/project-media/marakez/units/ap13-d-0.webp", "/project-media/marakez/units/ap13-d-01.webp", "/project-media/marakez/units/ap13-d-02.webp", "/project-media/marakez/units/ap13-d-03.webp", "/project-media/marakez/units/ap13-d-04.webp", "/project-media/marakez/units/ap13-d-05.webp"],
'D5-A14':["/project-media/marakez/units/ap14-d-0.webp", "/project-media/marakez/units/ap14-d-01.webp", "/project-media/marakez/units/ap14-d-02.webp", "/project-media/marakez/units/ap14-d-03.webp"],
...
'D5-A20':["/project-media/marakez/units/ap13-d-0.webp", "/project-media/marakez/units/ap13-d-01.webp", "/project-media/marakez/units/ap13-d-02.webp", "/project-media/marakez/units/ap13-d-03.webp", "/project-media/marakez/units/ap13-d-04.webp", "/project-media/marakez/units/ap13-d-05.webp"],
...
'CW-TW01':["/project-media/marakez/units/tw-cr-0.webp", "/project-media/marakez/units/tw-cr-01.webp", "/project-media/marakez/units/tw-cr-02.webp"],
...
'CW-V04':["/project-media/marakez/units/v4-cr-00.webp", "/project-media/marakez/units/v4-cr-001.webp", "/project-media/marakez/units/v4-cr-002.webp", "/project-media/marakez/units/v4-cr-003.webp", "/project-media/marakez/units/v4-cr-01.webp"],
'CW-A01':["/project-media/marakez/units/ap1-cr-00.webp", "/project-media/marakez/units/ap1-cr-0.webp", "/project-media/marakez/units/ap1-cr-001.webp", "/project-media/marakez/units/ap1-cr-002.webp", "/project-media/marakez/units/ap1-cr-003.webp"],
...
'CW-A04':["/project-media/marakez/units/ap5-cr-0.webp", "/project-media/marakez/units/ap5-cr-01.webp"],
...
'CW-A06':["/project-media/marakez/units/ap1-cr-002.webp", "/project-media/marakez/units/ap1-cr-0.webp", "/project-media/marakez/units/ap1-cr-00.webp", "/project-media/marakez/units/ap1-cr-001.webp", "/project-media/marakez/units/ap1-cr-003.webp"],
...
'CW-A07':["/project-media/marakez/units/ap1-cr-002.webp", "/project-media/marakez/units/ap1-cr-0.webp", "/project-media/marakez/units/ap1-cr-00.webp", "/project-media/marakez/units/ap1-cr-001.webp", "/project-media/marakez/units/ap1-cr-003.webp"],
'CW-TW03':["/project-media/marakez/units/tw-cr-02.webp", "/project-media/marakez/units/tw-cr-0.webp", "/project-media/marakez/units/tw-cr-01.webp"],
'CW-TW04':["/project-media/marakez/units/tw-cr-0.webp", "/project-media/marakez/units/tw-cr-01.webp", "/project-media/marakez/units/tw-cr-02.webp"],
'CW-A08':["/project-media/marakez/units/ap8-cr-0.webp", "/project-media/marakez/units/ap8-cr-01.webp", "/project-media/marakez/units/ap8-cr-02.webp", "/project-media/marakez/units/ap8-cr-03.webp"],
'CW-V06':["/project-media/marakez/units/v3-cr-02.webp", "/project-media/marakez/units/v3-cr-0.webp", "/project-media/marakez/units/v3-cr-01.webp", "/project-media/marakez/units/v3-cr-03.webp"],
'CW-V07':["/project-media/marakez/units/v3-cr-03.webp", "/project-media/marakez/units/v3-cr-0.webp", "/project-media/marakez/units/v3-cr-01.webp", "/project-media/marakez/units/v3-cr-02.webp"],
...
'CW-A11':["/project-media/marakez/units/ap2-cr-02.webp", "/project-media/marakez/units/ap2-cr-0.webp", "/project-media/marakez/units/ap2-cr-01.webp", "/project-media/marakez/units/ap2-cr-03.webp"],
...
'SB-AP-03':['/project-media/sumou/ap4-0.webp'],
'SB-AP-04':['/project-media/sumou/ap5-0.webp'],
'SB-OF-01':['/project-media/sumou/of0.webp','/project-media/sumou/of1.webp','/project-media/sumou/of3.webp','/project-media/sumou/of4.webp'],
'SB-OF-02':['/project-media/sumou/of2.webp','/project-media/sumou/of0.webp','/project-media/sumou/of1.webp','/project-media/sumou/of3.webp','/project-media/sumou/of4.webp'],
...
'MD-MON-03':['/project-media/modon/v1-mon-0.webp','/project-media/modon/v1-mon-03.webp','/project-media/modon/v1-mon-04.webp','/project-media/modon/v1-mon-01.webp'],
...
'TM-IM-09':['/project-media/tatweer/tm-lo-il-0.webp','/project-media/tatweer/tm-lo-il-01.webp','/project-media/tatweer/tm-lo-il-02.webp','/project-media/tatweer/tm-lo-il-03.webp'],
...
'TM-SL-03':['/project-media/tatweer/ch3-0.webp','/project-media/tatweer/ch3-01.webp'],
...
'TM-RV-01':['/project-media/tatweer/r-0.webp','/project-media/tatweer/r-01.webp','/project-media/tatweer/r-02.webp','/project-media/tatweer/r-03.webp','/project-media/tatweer/r-ap2-0.webp','/project-media/tatweer/r-ap2-01.webp'],
...
'TM-FK-01':['/project-media/tatweer/f-0.webp','/project-media/tatweer/f-01.webp','/project-media/tatweer/f-02.webp','/project-media/tatweer/fouka-serviced-apt.webp'],
...
'TM-DB-01':['/project-media/tatweer/ch-dp-0.webp','/project-media/tatweer/ch-dp-01.webp','/project-media/tatweer/ch-dp-02.webp','/project-media/tatweer/d-b-2.webp','/project-media/tatweer/d-bay-villa.webp','/project-media/tatweer/d-bay4.webp'],
...
'JN-CR1':['mp-JN-CR1.webp'], 'JN-OP1':['mp-JN-OP1.webp'],
'OG-WC1':['mp-OG-WC1.webp'], 'OG-TH1':['mp-OG-TH1.webp'], 'OG-TW1':['mp-OG-TW1.webp'],
'CS-TW1':['mp-CS-TW1.webp'], 'AL-V03':['mp-AL-V03.webp'],
'SEM-CL1':['/project-media/lmd/sem-cl1-mp1.webp'], 'SEM-CL2':['/project-media/lmd/sem-cl2-mp1.webp'],
'TS-AD1':['/project-media/lmd/ts-ad1-mp1.webp'], 'TS-AD2':['/project-media/lmd/ts-ad2-mp1.webp'], 'TS-CL3':['/project-media/lmd/ts-cl3-mp1.webp'],
'TS-AD4':['/project-media/lmd/ts-ad4-mp1.webp'], 'TS-OF5':['/project-media/lmd/ts-of5-mp1.webp'],
'STH-OF1':['/project-media/lmd/sth-of1-mp1.webp'], 'SES-AD1':['/project-media/lmd/ses-ad1-mp1.webp'], 'ON-RT1':['/project-media/lmd/on-rt1-mp1.webp'],
'ZY-SV1':['/project-media/lmd/zy-sv1-mp1.webp'], 'ZY-HV2':['/project-media/lmd/zy-hv2-mp1.webp'], 'ZY-TW3':['/project-media/lmd/zy-tw3-mp1.webp'],
'ZY-CH4':['/project-media/lmd/zy-ch4-mp1.webp'], 'ZY-CB5':['/project-media/lmd/zy-cb5-mp1.webp'],
...
'MB-CH01':["/project-media/baghush/units/fp-c1-0.webp"],
'MB-CH02':["/project-media/baghush/units/fp-c1-0.webp", "/project-media/baghush/units/fp-c1-01.webp"],
'MB-CH03':["/project-media/baghush/units/fp-ch3.webp"],
'MB-TW01':["/project-media/baghush/units/fp-t1-0.webp"],
...
'RM-VL02':['/project-media/ramla/units/fp-v2-0.webp'],
...
'CW-TW01':['/project-media/marakez/units/fp-tw1-cr-0.webp'],
'CW-V01':['/project-media/marakez/units/fp-v1-cr-0.webp'],
'CW-V03':['/project-media/marakez/units/fp-v3-c-0.webp'],
'CW-V05':['/project-media/marakez/units/fp-v5-cr-0.webp'],
...
'TM-FK-01':['/project-media/tatweer/fp-f-0.webp','/project-media/tatweer/80.webp'],
'TM-FK-02':['/project-media/tatweer/fp-f2.webp'],
'TM-FK-03':['/project-media/tatweer/80-b.webp'],
'TM-FK-04':['/project-media/tatweer/110.webp'],
'TM-DB-01':['/project-media/tatweer/fp-ch-dpay.webp','/project-media/tatweer/280-floor-plan.webp'],
'TM-DB-02':['/project-media/tatweer/fp-tw-db-0.webp','/project-media/tatweer/fp-tw-db-01.webp'],
'TM-DB-03':['/project-media/tatweer/280-s.webp'],
'TM-SC-01':['/project-media/tatweer/fp-th-sc.webp','/project-media/tatweer/fp-th-sc1.webp','/project-media/tatweer/villa-210-scenes-first-floor.webp','/project-media/tatweer/villa-second-floor-scenes.webp'],
...
'TM-SC-03':['/project-media/tatweer/fp-v-sc-0.webp'],
'JN-CR1':['fp-JN-CR1-1.webp'], 'JN-OP1':['fp-JN-OP1-1.webp'],
'OG-WC1':['fp-OG-WC1-1.webp','fp-OG-WC1-2.webp'],
'OG-TH1':['fp-OG-TH1-1.webp','fp-OG-TH1-2.webp'],
'OG-TW1':['fp-OG-TW1-1.webp','fp-OG-TW1-2.webp'],
'CS-TH1':['fp-CS-TH1-1.webp'], 'CS-TW1':['fp-CS-TW1-1.webp'],
'SEM-CL1':['/project-media/lmd/sem-cl1-fp1.webp','/project-media/lmd/sem-cl1-fp2.webp'], 'SEM-CL2':['/project-media/lmd/sem-cl2-fp1.webp'],
'TS-AD1':['/project-media/lmd/ts-ad1-fp1.webp'], 'TS-AD2':['/project-media/lmd/ts-ad2-fp1.webp'], 'TS-CL3':['/project-media/lmd/ts-cl3-fp1.webp'],
'TS-AD4':['/project-media/lmd/ts-ad4-fp1.webp'], 'TS-OF5':['/project-media/lmd/ts-of5-fp1.webp'],
'STH-OF1':['/project-media/lmd/sth-of1-fp1.webp'], 'SES-AD1':['/project-media/lmd/ses-ad1-fp1.webp'], 'ON-RT1':['/project-media/lmd/on-rt1-fp1.webp'],
'ZY-SV1':['/project-media/lmd/zy-sv1-fp1.webp'], 'ZY-HV2':['/project-media/lmd/zy-hv2-fp1.webp'], 'ZY-TW3':['/project-media/lmd/zy-tw3-fp1.webp'],
...
'TS-AD1':['/project-media/lmd/ts-ad1-loc1.webp'], 'TS-AD2':['/project-media/lmd/ts-ad2-loc1.webp'],
'TS-CL3':['/project-media/lmd/ts-cl3-loc1.webp'], 'TS-AD4':['/project-media/lmd/ts-ad4-loc1.webp'],
'TS-OF5':['/project-media/lmd/ts-of5-loc1.webp'], 'STH-OF1':['/project-media/lmd/sth-of1-loc1.webp'],
...
'beit-al-bahr':  ['bab_beach','bab_hotels','bab_finished','bab_landscape',
'bab_heart','bab_community','bab_lagoons','bab_fnb'],
...
var f = devFeatures(dev.key); if(!f || !f.masterplan) return null;
var m = f.masterplan, label = L({en:m.en, ar:m.ar}), nm = L(dev.name);
...
function devCardsSection(dev){
var f = devFeatures(dev.key); if(!f || !f.cards || !f.cards.length) return null;
var nm = L(dev.name);
...
var p = projBySlug(slug), dev = devByKey(p.dev), area = areaByKey(p.area);
...
var media = h('div',{class:'detail-media'}, projectMedia(p),
h('div',{class:'tags'}, h('span',{class:'chip'}, statusLabel(p.status))));
...
h('div',{style:'display:flex;gap:8px;flex-wrap:wrap;margin-top:14px'}, (lang==='ar'?p.tags.ar:p.tags.en).map(function(x){return h('span',{class:'chip'},x);})),
(function(){
...
var media=h('div',{class:'detail-media'+(galItems.length?' detail-media--gal':'')});
if(galItems.length){
var gidx=0, gn=galItems.length;
var gimg=h('img',{class:'artsvg proj-cover', src:galItems[0].src, alt:pnm+' — '+tl, loading:'lazy', decoding:'async'});
gimg.addEventListener('error', function(){ if(gimg.parentNode) gimg.parentNode.replaceChild(projectArt(p), gimg); });
var gnum=h('span',{class:'gal-badge__n'});
var gshow=function(i){ gidx=(i+gn)%gn; gimg.src=galItems[gidx].src; gnum.textContent = gn>1 ? ((gidx+1)+' / '+gn) : (num(gn)+' '+(lang==='ar'?'صورة':'photo')); };
media.appendChild(gimg);
media.appendChild(h('div',{class:'tags'}, h('span',{class:'chip'}, typeIconC(unitCanon(u),'chip-ico'), tl)));
media.appendChild(h('span',{class:'gal-badge','aria-hidden':'true'}, ic('gallery','gal-badge__ic'), gnum));
if(gn>1){
var gprev=h('button',{class:'gal-nav gal-nav--prev', type:'button','aria-label':(lang==='ar'?'الصورة السابقة':'Previous photo')}, ic('chevleft'));
var gnext=h('button',{class:'gal-nav gal-nav--next', type:'button','aria-label':(lang==='ar'?'الصورة التالية':'Next photo')}, ic('chevright'));
gprev.addEventListener('click', function(e){ e.stopPropagation(); e.preventDefault(); gshow(gidx-1); });
gnext.addEventListener('click', function(e){ e.stopPropagation(); e.preventDefault(); gshow(gidx+1); });
media.appendChild(gprev); media.appendChild(gnext);
}
gimg.addEventListener('click', function(){ mediaViewer(galItems, pnm, gidx); });
gshow(0);
} else {
media.appendChild(unitMedia(u));
media.appendChild(h('div',{class:'tags'}, h('span',{class:'chip'}, typeIconC(unitCanon(u),'chip-ico'), tl)));
}
var aside=h('aside',{class:'aside-card'},
h('div',{class:'muted',style:'font-size:.8rem;font-weight:700'}, t('price')),
